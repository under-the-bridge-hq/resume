...
- NTTコンピューティングテクノロジーセンタ センタ長（モデレーター）、NTTドコモ Senior Principal Architect、ぐるなび CTO とともに、AIエージェントのモデル以外の部分（スキル・ガードレール整備など）としての「ハーネス」をめぐり、開発・運用スタイルの変化や実際のツールセット、失敗談を議論
