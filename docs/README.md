...
- **課題:**
  - AI Coding Agentを組織として安全に活用するための方針・ガードレールが未整備
  - 開発生産性を高めつつ、機密情報・権限管理などセキュリティ要件と両立させる必要がある
- **支援:**
  - AI Coding Agentの組織での利活用支援
  - セキュリティを考慮した組織への実装支援
- **成果（支援開始）:**
  - CTOと直接会話しながら課題探査・提案を高速に繰り返し、改善活動を実施中

**G社 (レピュテーションリスク管理SaaS / 社員数数百人 / 2026年5月〜)**

- **課題:**
  - 事業成長に伴い、信頼性・運用品質を担保するSRE体制の強化が必要
- **支援:**
  - SRE業務支援
- **成果（支援開始）:**
  - CTOと直接会話しながら課題探査・提案を高速に繰り返し、改善活動を実施中
