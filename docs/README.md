...
現在は株式会社タイミーでAgent Harness Groupのグループマネージャーとして、AI Coding Agentの組織導入における生産性と安全性の共進化を推進しつつ、副業の [合同会社Under The Bridge](https://under-the-bridge.co.jp/) で複数社を支援中です。
